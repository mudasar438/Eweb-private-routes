...
function Section() {
  ...
  return (
    <div className="max-w-screen-2xl mx-auto bg-slate-500 text-white">
      <div className="flex flex-col  md:flex-row justify-center w-[90%] mx-auto h-[100vh]">
        <div className="">
          ...
          <div className="">
            ...
            <div className="roola">
              <button
                onClick={() => addToCart()}
                className="p-2 my-2 text-2xl font-bold w-[50%] text-white bg-gray-700"
              >
                Add to Cart
              </button>
            </div>
            <button
              ...
              className="p-2 text-lg text-white w-[50%] bg-black rounded font-lg"
            >
              Go Back
            </button>
          </div>
        ...
        <div className="w-2/4 text-center border-[4px] py-10 mt-2 border-white my-5">
          ...
          <div className="flex items-center justify-center gap-10 pt-5 text-lg font-bold">
            <h1>Images</h1>
          ...
          {cart.map((item, i) => (
            <div
              key={i}
              className="flex justify-center gap-10 py-10 item-center border-2 mt-5 mx-5"
            >
